"""
ThreadedMixedDemos.py - a combination of Chain, Image and Text animations running at the same time
...
This demo uses the new extensions to Animator.py which allow you to stop and start the animations at will
