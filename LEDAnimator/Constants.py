...
# this just makes it easier to see the list of supported fonts
FONT_HERSHEY_SIMPLEX=cv2.FONT_HERSHEY_SIMPLEX
FONT_HERSHEY_PLAIN=cv2.FONT_HERSHEY_PLAIN
FONT_HERSHEY_DUPLEX=cv2.FONT_HERSHEY_DUPLEX
FONT_HERSHEY_COMPLEX=cv2.FONT_HERSHEY_SIMPLEX
FONT_HERSHEY_TRIPLEX=cv2.FONT_HERSHEY_SIMPLEX
